...
{
    public class LoginComponentPage:Base
    {
#pragma warning disable
        ...
        public void LoginDetails()
        {
            ...
            string jsonFilePath = "D:\\IC Course\\AdvanceSpecflow\\Mars-AdvanceSpecflow\\SpecflowAutomation\\JsonData\\Login1data.json";
...
#pragma warning disable CS8602
            ...
            Wait.WaitToBeClickable(driver, "XPath", "//button[text()='Login']", 15);
            loginButton.Click();
        }
    }
}
